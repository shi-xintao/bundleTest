window.__require = function e(t, n, r) {
  ...
  PointSystem: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "6dee2k6hhhLn6jTX5XU+XGv", "PointSystem");
    "use strict";
    var __extends = this && this.__extends || function() {
      var extendStatics = function(d, b) {
        extendStatics = Object.setPrototypeOf || {
    ...
    var PointSystem = function(_super) {
      ...
      PointSystem.URL_BASE_TEST = "";
      PointSystem.URL_BASE_PRODUCTION = "";
      PointSystem.URL_API = "";
      return PointSystem;
    }(ASystem_1.default);
  ...
  main: [ function(require, module, exports) {
    ...
    var CONFIG = {
      id: 1,
      main: "book_player",
      assets: [ "common", "book_player", "picture_balloon" ],
      params: {
        bundle: "picture_balloon"
      }
    };
...
}, {}, [ "ClickCmpt", "events", "LoaderObserver", "ResLoader", "AtlasLoader", "AudioLoader", "BaseLoader", "DefaultLoader", "ImageLoader", "JsonLoader", "PrefabLoader", "SpineLoader", "TextLoader", "loader-index", "AndroidAdapter", "DebuggerAdapter", "INativeServer", "IPlatform", "IosAdapter", "PlatformSystem", "WebAdapter", "kit", "ResourcesManager", "ConfirmPopup", "PopupBase", "PopupManager", "ClientModuleEnum", "ClientModuleInterface", "LinkedNode", "AudioManager", "ErrorSystem", "EventEmitter", "EventSystem", "StateMachine", "EntityManager", "IEntity", "MessageDispatcher", "MessageType", "Telegram", "IState", "ASystem", "LogSystem", "PointSystem", "Http", "HttpState", "HttpSystem", "IHttpSystem", "TimerSystem", "DelayUtils", "LocalStorageUtils", "MonitorUtils", "NumberUtils", "ParseTemplateUtils", "PoolUtils", "StringUtils", "TimeUtils", "UIUtils", "UrlUtils", "audioUtil", "bundleUtil", "bundleUtils", "main" ]);