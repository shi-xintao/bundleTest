window.__require = function e(t, n, r) {
  ...
  PBPageContainer: [ function(require, module, exports) {
    ...
    var PBPageContainer = function(_super) {
      ...
      PBPageContainer.prototype.start = function() {
        ...
        leftNode.is3DNode = true;
        leftNode.anchorX = 1;
        this.leftHalf = leftNode.addComponent(cc.Sprite);
        ...
        rightNode.anchorX = 0;
        this.rightHalf = rightNode.addComponent(cc.Sprite);
        this.node.addChild(rightNode);
        rightNode.width = this.node.width / 2;
        rightNode.height = this.node.height;
        rightNode.x = 0;
        rightNode.y = 0;
        var leftNode2 = new cc.Node();
        leftNode2.is3DNode = true;
        leftNode2.anchorX = 1;
        this.leftHalf2 = leftNode2.addComponent(cc.Sprite);
        this.node.addChild(leftNode2);
        leftNode2.width = this.node.width / 2;
        leftNode2.height = this.node.height;
        leftNode2.x = 0;
        leftNode2.y = 0;
        var rightNode2 = new cc.Node();
        rightNode2.is3DNode = true;
        rightNode2.anchorX = 0;
        this.rightHalf2 = rightNode2.addComponent(cc.Sprite);
        this.node.addChild(rightNode2);
      ...
      Object.defineProperty(PBPageContainer.prototype, "nextPage", {
        get: function() {
          if (this.currPageIndex + 1 < PictureBookPlayer_1.default.instance.config.page_count) return this.pages.get(this.currPageIndex + 1);
          return null;
        },
        enumerable: false,
        configurable: true
                ...
                return __generator(this, function(_a) {
                  switch (_a.label) {
                   ...
                   case 1:
                    ...
                    if (!("3d" == PictureBookPlayer_1.default.instance.config.turn_mode)) return [ 3, 2 ];
                    cc.Camera.main.ortho = false;
                    return [ 3, 4 ];

                   case 2:
                    if (!("verlet" == PictureBookPlayer_1.default.instance.config.turn_mode)) return [ 3, 4 ];
                   ...
                   case 4:
                    if ("verlet" != PictureBookPlayer_1.default.instance.config.turn_mode) {
                      this.leftHalf.spriteFrame = currPage.leftSpf;
                      ...
                      cc.tween(this.leftHalf2.node).delay(PBPageContainer_1.TURN_DURATION / 2).call(function() {
                        ...
                        _this.rightHalf.node.active = false;
                        _this.currPageIndex = nextPage.index;
                        "3d" == PictureBookPlayer_1.default.instance.config.turn_mode && (cc.Camera.main.ortho = true);
                        resolve();
                      }).start();
                    }
                    return [ 2 ];
      ...
      PBPageContainer.prototype.unloadNext = function() {
        var index = this.currPageIndex + 2;
        if (index < PictureBookPlayer_1.default.instance.config.page_count) {
          var page = this.pages.get(index);
          var name = page.config.prefab;
          page && page.node.destroy();
          var prefab = this.prefabs.get(index);
        ...
        return __awaiter(this, void 0, void 0, function() {
          return __generator(this, function(_a) {
            switch (_a.label) {
             ...
             case 1:
              _a.sent();
              if (!(this.currPageIndex < PictureBookPlayer_1.default.instance.config.page_count - 1)) return [ 3, 3 ];
  ...
  PBPage: [ function(require, module, exports) {
    ...
    var PBPage = function(_super) {
          ...
          return __generator(this, function(_a) {
            switch (_a.label) {
             case 0:
              ...
              this.config = PictureBookPlayer_1.default.instance.getConfig(this.index);
              this.fixBg();
             ...
             case 1:
              ...
              this.config.music && AudioManager_1.default.playMusic(PictureBookPlayer_1.default.instance.config.bundle, "music/" + this.config.music);
              return [ 2 ];
            }
          });
        });
      ...
      PBPage.prototype.getSound = function(index) {
        ...
        if (0 == this.config.sound.length) return null;
        if (index < 0 || index > this.config.sound.length - 1) return null;
        var sound = this.config.sound[index];
        var type = typeof sound;
      ...
      PBPage.prototype.getVoice = function(index) {
        ...
        if (0 == this.config.voice.length) return null;
        if (index < 0 || index > this.config.voice.length - 1) return null;
        var sound = this.config.voice[index];
        var type = typeof sound;
        if ("object" == type) return {
          ...
          return __generator(this, function(_a) {
            switch (_a.label) {
             case 0:
              ...
              return [ 4, AudioManager_1.default.playEffectByName(PictureBookPlayer_1.default.instance.config.bundle, sound.name, true, sound.loop) ];
      ...
      PBPage.prototype.onDestroy = function() {
        ...
        this.config.voice && this.config.voice.forEach(function(sound) {
          var type = typeof sound;
          var name = "";
          "object" == type ? name = sound.name : "string" == type && (name = sound);
          AudioManager_1.default.destroyAudio(PictureBookPlayer_1.default.instance.config.bundle, "voice/" + name);
        });
        this.config.sound && this.config.sound.forEach(function(sound) {
          var type = typeof sound;
          var name = "";
          "object" == type ? name = sound.name : "string" == type && (name = sound);
          AudioManager_1.default.destroyAudio(PictureBookPlayer_1.default.instance.config.bundle, "sound/" + name);
        });
        this.config.music && AudioManager_1.default.destroyAudio(PictureBookPlayer_1.default.instance.config.bundle, "music/" + this.config.music);
      };
      PBPage.prototype.stopAllSounds = function() {
        this.config.voice && this.config.voice.forEach(function(sound) {
          ...
          if ("object" == type) {
            name = "voice/" + sound.name;
            isloop = sound.loop;
          } else "string" == type && (name = "voice/" + sound);
          isloop ? AudioManager_1.default.stopLoopEffect(PictureBookPlayer_1.default.instance.config.bundle, name) : AudioManager_1.default.stopEffectByName(name);
        });
        this.config.sound && this.config.sound.forEach(function(sound) {
          var type = typeof sound;
          var name = "";
          ...
          if ("object" == type) {
            name = "sound/" + sound.name;
            isloop = sound.loop;
          } else "string" == type && (name = "sound/" + sound);
          isloop ? AudioManager_1.default.stopLoopEffect(PictureBookPlayer_1.default.instance.config.bundle, name) : AudioManager_1.default.stopEffectByName(name);
        });
        this.config.music && AudioManager_1.default.stopMusic();
      };
  ...
  PictureBookPlayer: [ function(require, module, exports) {
    ...
    var PictureBookPlayer = function(_super) {
      ...
      PictureBookPlayer.prototype.getConfig = function(index) {
        return this.config.pages["" + (index + 1)];
      };
      Object.defineProperty(PictureBookPlayer.prototype, "currConfig", {
        get: function() {
          ...
          return __generator(this, function(_a) {
            ...
            return [ 2, new Promise(function(resolve) {
              bundleUtils_1.loadBundle(_this.book_bundle_name).then(function(bundle) {
                _this.book_bundle = bundle;
                _this.book_bundle.load("custom/left_arrow", cc.Prefab, function(error, prefab) {
                  if (error) {
                    _this.left_arrow.active = true;
                    return;
                  }
                  var left_arrow = cc.instantiate(prefab);
                  _this.left_slot.addChild(left_arrow);
                });
                _this.book_bundle.load("custom/right_arrow", cc.Prefab, function(error, prefab) {
                  if (error) {
                    _this.right_arrow.active = true;
                    return;
                  }
                  var right_arrow = cc.instantiate(prefab);
                  _this.right_slot.addChild(right_arrow);
                });
                _this.book_bundle.load("custom/bottom_area", cc.Prefab, function(error, prefab) {
                  if (error) {
                    _this.bottomArea.node.active = true;
                    return;
                  }
                  var bottom_area = cc.instantiate(prefab).getComponent(PBBottomArea_1.default);
                  _this.bottomArea = bottom_area;
                  _this.node.addChild(bottom_area.node);
                });
                _this.book_bundle.load("setting", cc.JsonAsset, function(error, txt) {
                  return __awaiter(_this, void 0, void 0, function() {
                    return __generator(this, function(_a) {
                      switch (_a.label) {
                       case 0:
      ...
      PictureBookPlayer.prototype.onLoad = function() {
        ...
        this.left_arrow.active = false;
        this.right_arrow = cc.find("right_arrow", this.right_slot);
        this.right_arrow.active = false;
        ...
        return __awaiter(this, void 0, void 0, function() {
          return __generator(this, function(_a) {
            if (page.index == this.page.currPageIndex) {
              page.config.text && page.config.text.length > 0 && PictureBookPlayer_1.instance.setText(page.config.text[0]);
              page.config.sound && page.config.sound.length > 0 && page.playSound(0);
              this.pageTimer(page);
            }
            return [ 2 ];
          });
      ...
      PictureBookPlayer.prototype.pageTimer = function(page) {
        ...
        if (page.config.voice && page.config.voice.length > 0) this.config.autoturnpage > 0 ? page.playVoice(0).then(function() {
          if (_this.playMode == PictureBookPlayer_1.PLAY_MODE_AUTO) {
            _this.needAutoTurnPage = true;
            _this.restTime = _this.config.autoturnpage_after_voice;
          }
        }) : page.playVoice(0); else {
          this.needAutoTurnPage = true;
          this.restTime = this.config.autoturnpage;
        }
      };
      ...
      PictureBookPlayer.prototype.updatePageNum = function() {
        this.bottomArea.page_num.string = this.page.currPageIndex + 1 + "/" + this.config.page_count;
      };
      PictureBookPlayer.prototype.loadAllPages = function() {
        return __awaiter(this, void 0, void 0, function() {
          var _this = this;
          return __generator(this, function(_a) {
      ...
      PictureBookPlayer.prototype.loadPage = function(index) {
        return __awaiter(this, void 0, void 0, function() {
          ...
          return __generator(this, function(_a) {
            return [ 2, new Promise(function(resolve) {
              var conf = _this.getConfig(index);
      ...
      PictureBookPlayer.prototype.onRightArrowClicked = function() {
        return __awaiter(this, void 0, void 0, function() {
          return __generator(this, function(_a) {
            switch (_a.label) {
             case 0:
              if (this.page.currPageIndex == this.config.page_count - 1) return [ 2 ];
              this.needAutoTurnPage = false;
              this.restTime = 0;
              this.onPageUnLoaded(this.page.currPage);
