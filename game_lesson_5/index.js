  ...
  gameMain: [ function(require, module, exports) {
    ...
    var gameMain = function(_super) {
      ...
      gameMain.prototype.onLoad = function() {
        ...
        EventSystem_1.default.on("Day5_Game_Over", this.GameOver, this);
      ...
      gameMain.prototype.playerHurt = function() {
        ...
        this.playerHpNodes[this.playerHp].getComponent(cc.Animation).on("finished", function() {
          0 == _this.playerHp && _this.GameOver();
        });
      };
      ...
      gameMain.prototype.onDestroy = function() {
        EventSystem_1.default.off("Day5_Game_Over", this.GameOver, this);
