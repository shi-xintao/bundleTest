window.__require = function e(t, n, r) {
  ...
  BaseChapterComponent: [ function(require, module, exports) {
    ...
    var BaseChapterComponent = function(_super) {
      ...
      BaseChapterComponent.prototype.unregisterEvent = function() {
        EventSystem_1.default.off(events_1.LIFE_CYCLE_BLOCK, this.onLifeCycleBlock, this);
        EventSystem_1.default.off(events_1.LIFE_CYCLE_UNBLOCK, this.onLifeCycleUnBlock, this);
      };
  ...
  ChapterGameComponent: [ function(require, module, exports) {
    ...
    var ChapterGameComponent = function(_super) {
      ...
      ChapterGameComponent.prototype.startRecordAudio = function(evaluatingText, bundleName, audioUrl, iconPath, recordType) {
        EventSystem_1.default.emit(events_1.FOLLOW_CLIENT_TO_MODULE, {
      ...
      ChapterGameComponent.prototype.reportRoundCompleted = function(index, isSuccess) {
        cc.log("report round data  index: " + index + "  isSuccess: " + isSuccess);
      };
      ChapterGameComponent.prototype.onGameEnd = function(isSuccess) {
        void 0 === isSuccess && (isSuccess = true);
        cc.log(" onGameEnd ~~");
      };
  ...
  Hand: [ function(require, module, exports) {
    ...
    var Hand = function(_super) {
      ...
      Hand.prototype.playDown = function(callback) {
        this.playSwipeByAngle(0, "changdian", false);
        callback && this.sp.setCompleteListener(callback);
      };
      Hand.prototype.playUp = function(callback) {
      ...
      Hand.prototype.setTargetNode = function(target, parent, expand) {
        void 0 === expand && (expand = 0);
  ...
  lessonUtil: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "4f739vXC0pJHZWF6H+lfoDQ", "lessonUtil");
    "use strict";
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
    exports.lessonUtil = void 0;
    var ResourcesManager_1 = require("../../kit/manager/ResourcesManager");
    var lessonUtil = function() {
      function lessonUtil() {}
      lessonUtil.getRightFeedBackAni = function() {
        return new Promise(function(res, rej) {
          ResourcesManager_1.default.instance.loadRes("common", "feedBack/right", ResourcesManager_1.ResourceType.Normal, cc.Prefab, function(e, pre) {
            if (pre) {
              var node_1 = cc.instantiate(pre);
              var ske = node_1.getComponent(sp.Skeleton);
              ske.setCompleteListener(function() {
                return node_1.destroy();
              });
              res(node_1);
            } else {
              console.log(e);
      ...
      lessonUtil.getErrorFeedBackAni = function() {
        return new Promise(function(res, rej) {
          ResourcesManager_1.default.instance.loadRes("common", "feedBack/error", ResourcesManager_1.ResourceType.Normal, cc.Prefab, function(e, pre) {
            if (pre) {
              var node_2 = cc.instantiate(pre);
              var ske = node_2.getComponent(sp.Skeleton);
              ske.setCompleteListener(function() {
                return node_2.destroy();
              });
              res(node_2);
            } else {
              console.log(e);
...
}, {}, [ "TaskBoard", "gameTask", "Hand", "RollerAnimation", "AdapterBg", "AdapterScreen", "BaseChapterComponent", "ChapterGameComponent", "rollBg", "CompEnum", "CompInterface", "SpineUtils", "lessonUtil", "Assembler2D", "LSprite", "SpriteAssembler" ]);
