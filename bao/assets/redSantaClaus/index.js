window.__require = function e(t, n, r) {
  ...
  box: [ function(require, module, exports) {
    ...
    var Box = function(_super) {
      ...
      Box.prototype.checkItem = function(item) {
      ...
      Box.prototype.checkBoxEnd = function() {
        ...
        if (this.objectTypeArr.length >= 2) {
          ...
          AudioManager_1.default.playEffect("redSantaClaus", "audio/SE_shengdanlaoren07_ytz");
  ...
  comp: [ function(require, module, exports) {
    ...
    function playSpineAnimation(spine, animation, loop, trackIndex) {
      ...
      return loop ? Promise.resolve().then(function() {
  ...
  moveItem: [ function(require, module, exports) {
    ...
    var MoveItem = function(_super) {
      ...
      MoveItem.prototype.touchStart = function() {
        ...
        this.mainNode.getComponent(redSantaClaus_1.default).touchStart();
      };
      ...
      MoveItem.prototype.showGuide = function() {
        this.mainNode.getComponent(redSantaClaus_1.default).showGuide();
      };
  ...
  redSantaClaus: [ function(require, module, exports) {
    ...
    var RedSantaClaus = function(_super) {
      ...
      function RedSantaClaus() {
        ...
        _this.MUSIC_PATH = "audio/";
        _this.BUNDLE_NAME = "redSantaClaus";
        _this.MUSIC_BG = "BGM_shengdanlaoren01_ytz";
        _this.MUSIC_SUCCESS = "SE_shengdanlaoren07_ytz";
        _this.gameTotal = 5;
      ...
      RedSantaClaus.prototype.onLoad = function() {
        ...
        AudioManager_1.default.playMusic(this.BUNDLE_NAME, "" + this.MUSIC_PATH + this.MUSIC_BG);
      };
      ...
      RedSantaClaus.prototype.hideHand = function() {
        this.gameHandCount = 0;
        this.hand.hide();
        this.hideBlockNode();
      };
      RedSantaClaus.prototype.touchStart = function() {
        this.timerKey && clearInterval(this.timerKey);
      };
      RedSantaClaus.prototype.showGuide = function() {
        var _this = this;
        this.timerKey && clearInterval(this.timerKey);
        this.timerKey = setInterval(function() {
          if (_this.gameFirstCount < 3) {
            _this.handNode.active = true;
            _this.guide2Target();
            _this.handNode.on(cc.Node.EventType.TOUCH_START, function(event) {
              _this.hideHand();
            });
          }
        }, 3e3);
      };
      RedSantaClaus.prototype.guide2Target = function() {
        var _this = this;
        var box = this.boxNode.children.find(function(element) {
          return false === element.getChildByName("endBoxNode").active;
        });
        var item = this.moveNode.children.find(function(element) {
      ...
      RedSantaClaus.prototype.showSmoke = function() {
      ...
      __decorate([ property(cc.Node) ], RedSantaClaus.prototype, "boxNode", void 0);
      ...
      __decorate([ property(sp.Skeleton) ], RedSantaClaus.prototype, "smokeAnimation", void 0);
      __decorate([ property({
        type: cc.Prefab,
        displayName: "\u5f15\u5bfc\u624b"
  ...
  role: [ function(require, module, exports) {
    ...
    var Role = function(_super) {
      ...
      Role.prototype.random = function() {
        var temp = Math.random();
        cc.log("idle2," + temp);
        if (temp < .3) {
          comp_1.playSpineAnimation(this.sk, ROLE_ANI.IDLE2, true);
